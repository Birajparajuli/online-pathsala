...
-- CreateIndex
CREATE INDEX "CourseRatting_courseId_idx" ON "CourseRatting"("courseId");
...
-- AddForeignKey
ALTER TABLE "CourseRatting" ADD CONSTRAINT "CourseRatting_courseId_fkey" FOREIGN KEY ("courseId") REFERENCES "Course"("id") ON DELETE CASCADE ON UPDATE CASCADE;
