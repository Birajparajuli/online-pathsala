        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-16">
          <div>
            <div className="flex items-center gap-x-2">
              ...
              <h2 className="text-lg font-bold"> Customize your course</h2>
            </div>
            <div>
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-center gap-x-2">
              ...
              <h2 className="text-lg font-bold">Sell your course</h2>
            </div>
            <div>
            ...
            <div>
              <div className="flex items-center gap-x-2">
                <IconBadge icon={File} />
                <h2 className="text-lg font-bold">Resources and Attachment</h2>
              </div>
              <div>
